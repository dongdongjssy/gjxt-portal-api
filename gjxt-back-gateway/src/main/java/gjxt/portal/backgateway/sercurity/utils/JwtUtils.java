package gjxt.portal.backgateway.sercurity.utils;
...
//                && !isCreatedBeforeLastPasswordReset(created, userDetail.getLastPasswordResetDate())
    ...
    private String generateAccessToken(UserDetail userDetail) {
        ...
        List<String> list = authoritiesToArray(userDetail.getAuthorities());
        if(!list.isEmpty()){
    ...
    private Map<String, Object> generateClaims(UserDetail userDetail) {
        ...
        claims.put(JwtConfig.CLAIM_KEY_STATUS, userDetail.getUser().getStatus());
        return claims;
    }
