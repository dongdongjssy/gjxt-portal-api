...
@TableName("gjxt_work_update")
@ToString
@JsonInclude(JsonInclude.Include.NON_NULL)
public class GjxtWorkUpdate extends GjxtBaseEntity implements Serializable {
